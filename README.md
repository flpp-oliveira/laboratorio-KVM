...
Bem-vindo ao repositório de laboratório KVM! Este repositório foi criado para automatizar a configuração de um laboratório virtual usando o KVM como hypervisor. É fornecido três scripts bash - "script-01-kvm.sh", "script-02-template.sh" e "script-03-run.sh" - que simplificam a configuração do laboratório.
